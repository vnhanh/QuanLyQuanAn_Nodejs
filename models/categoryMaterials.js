...
const idValidators = [
  ...
  {
    validator: validId,
    message: 'Mã loại nguyên liệu không chứa ký tự đặt biệt!'
  }
];
...
const nameValidators = [
  {
    ...
    message:'Tên loại nguyên liệu có tối đa là 30 ký tự!'
  }
];



const categoryMaterialsSchema = new Schema({
...
module.exports = mongoose.model('CategoryMaterials', categoryMaterialsSchema);